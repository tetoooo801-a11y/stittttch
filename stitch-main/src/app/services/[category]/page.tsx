    ...
    <div className="pt-[100px] md:pt-[120px] pb-24 bg-background">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((item) => (
            <div key={item._id} className="glass-card rounded-2xl overflow-hidden shadow-md hover-lift group h-full">
              <Link href={`/services/treatment-details?id=${item._id}`}>
                <div className="relative aspect-[4/3] w-full overflow-hidden img-zoom-container">
                  {item.badgeKey && (
